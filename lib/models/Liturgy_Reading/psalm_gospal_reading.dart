...
class PsalmGospalReading extends ChangeNotifier {
...
List<PsalmGospalReading>? getReadingsForCoptic(CopticDate copticDate) {
  final monthKey = copticMonthKeyFromIndex(copticDate.month);
  final day = copticDate.day;

  if (!PsalmGospalReading.Psalmreading.containsKey(monthKey)) return null;
  final monthMap = PsalmGospalReading.Psalmreading[monthKey]!;
  ...
  return dayList.cast<PsalmGospalReading>();
}

/// Convert a Gregorian [DateTime] to Coptic and return associated readings.
List<PsalmGospalReading>? getReadingsForGregorian_psalm_gospal(
