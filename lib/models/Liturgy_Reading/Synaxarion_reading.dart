...
class SynaxarionReading extends ChangeNotifier {
...
List<SynaxarionReading>? getReadingsForCoptic(CopticDate copticDate) {
  final monthKey = copticMonthKeyFromIndex(copticDate.month);
  final day = copticDate.day;

  if (!SynaxarionReading.Psalmreading.containsKey(monthKey)) return null;
  final monthMap = SynaxarionReading.Psalmreading[monthKey]!;
  ...
  return dayList.cast<SynaxarionReading>();
}

/// Convert a Gregorian [DateTime] to Coptic and return associated readings.
List<SynaxarionReading>? getReadingsForGregorian_Synaxarion(
